...
export const MobileMethodSteps = ({ steps }: MobileMethodStepsProps) => {
  return (
    <div className="relative w-full px-6 pt-0 pb-10 flex flex-col min-h-dvh overflow-hidden bg-[linear-gradient(to_bottom,#000000_0%,#0c0c0c_15%,#0c0c0c_85%,#000000_100%)]">
